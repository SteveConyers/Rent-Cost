...
// Rent.java by Steven Conyers - 3/1/2022

// This program gets input from the user and outputs a cost from an array depending
// on the input the user has entered.
// Using a nested do-while loop with a nested while, if user enters an incorrect variable
// the user is prompted with a display message.
	...
	public static void main(String[] args) {
		...
		do {
			...
			while (level < 0 || level > 2) {
				System.out.print(
						"Your choice was out of range." + " Would you like a" + " level '0', '1', or '2' apartment! ");
				level = myInput.nextInt();
		...
		do {
			...
			while (bedrooms < 0 || bedrooms > 3) {
				System.out.print("Your choice was out of range." + " Would you like a"
						+ " '0', '1', '2', or '3' bedroom apartment? ");
				bedrooms = myInput.nextInt();
			}
		} while (bedrooms < 0 || bedrooms > 3);
